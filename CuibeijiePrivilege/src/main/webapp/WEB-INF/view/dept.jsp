...
<script type="application/javascript">
    $(function() {
        ...
        function loadDeptTree() {
            $.ajax({
                url: "/CuibeijiePrivilege/sys/dept/tree.json",
        ...
        function bindDeptClick() {
            ...
            $(".dept-delete").click(function (e) {
                ...
                if (confirm("确定要删除部门[" + deptName + "]吗?")) {
                    $.ajax({
                        url: "/CuibeijiePrivilege/sys/dept/delete.json",
                        data: {
                            id: deptId
                        },
                        success: function (result) {
        ...
        function loadUserList(deptId) {
            ...
            var url = "/CuibeijiePrivilege/sys/user/page.json?deptId=" + deptId;
        ...
        function bindUserClick() {
            $(".user-acl").click(function (e) {
                ...
                $.ajax({
                    url: "/CuibeijiePrivilege/sys/user/acls.json",
                    data: {
                        userId: userId
                    },
                    success: function(result) {
        ...
        function updateUser(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/CuibeijiePrivilege/sys/user/save.json" : "/CuibeijiePrivilege/sys/user/update.json",
        ...
        function updateDept(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/CuibeijiePrivilege/sys/dept/save.json" : "/CuibeijiePrivilege/sys/dept/update.json",
