...
<script type="text/javascript">
    $(function() {
        ...
        function loadAclModuleTree() {
            $.ajax({
                url: "/CuibeijiePrivilege/sys/aclModule/tree.json",
        ...
        function updateAclModule(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/CuibeijiePrivilege/sys/aclModule/save.json" : "/CuibeijiePrivilege/sys/aclModule/update.json",
        ...
        function updateAcl(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/CuibeijiePrivilege/sys/acl/save.json" : "/CuibeijiePrivilege/sys/acl/update.json",
        ...
        function bindAclModuleClick() {
            ...
            $(".aclModule-delete").click(function (e) {
                ...
                if (confirm("确定要删除权限模块[" + aclModuleName + "]吗?")) {
                    $.ajax({
                        url: "/CuibeijiePrivilege/sys/aclModule/delete.json",
                        data: {
                            id: aclModuleId
                        },
                        success: function (result) {
        ...
        function loadAclList(aclModuleId) {
            ...
            var url = "/CuibeijiePrivilege/sys/acl/page.json?aclModuleId=" + aclModuleId;
        ...
        function bindAclClick() {
            $(".acl-role").click(function (e) {
                ...
                $.ajax({
                    url: "/CuibeijiePrivilege/sys/acl/acls.json",
                    data: {
                        aclId: aclId
                    },
                    success: function(result) {
