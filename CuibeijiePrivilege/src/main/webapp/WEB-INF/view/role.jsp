...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath%>/ztree/zTreeStyle.css" type="text/css">
    <link rel="stylesheet" href="<%=basePath%>/assets/css/bootstrap-duallistbox.min.css" type="text/css">
    <script type="text/javascript" src="<%=basePath%>/ztree/jquery.ztree.all.min.js"></script>
    <script type="text/javascript" src="<%=basePath%>/assets/js/jquery.bootstrap-duallistbox.min.js"></script>
    <style type="text/css">
...
<script type="text/javascript">
    $(function () {
        ...
        function loadRoleList() {
            $.ajax({
                url: "/CuibeijiePrivilege/sys/role/list.json",
        ...
        function loadRoleAcl(selectedRoleId) {
            ...
            $.ajax({
                url: "/CuibeijiePrivilege/sys/role/roleTree.json",
                data : {
        ...
        $(".saveRoleAcl").click(function (e) {
            ...
            $.ajax({
                url: "/CuibeijiePrivilege/sys/role/changeAcls.json",
                data: {
                    roleId: lastRoleId,
        ...
        function updateRole(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/CuibeijiePrivilege/sys/role/save.json" : "/CuibeijiePrivilege/sys/role/update.json",
        ...
        function loadRoleUser(selectedRoleId) {
            $.ajax({
                url: "/CuibeijiePrivilege/sys/role/users.json",
                data: {
                    roleId: selectedRoleId
                },
                type: 'POST',
        ...
        $(".saveRoleUser").click(function (e) {
            ...
            $.ajax({
                url: "/CuibeijiePrivilege/sys/role/changeUsers.json",
                data: {
                    roleId: lastRoleId,
